...
# General information
YOUR_EMAIL = "cluong2@illinois.edu" # <put your coursera account email>,
YOUR_SECRET = "" # <put your secret token from coursera>

# Section 1
IP_ADDRESS1 = "3.134.104.196" # <put your first EC2 instance's IP address:port>
IP_ADDRESS2 = "3.134.104.196" # <put your second instance's IP address:port>
YOUR_LOAD_BALANCER1 = "mp2-1-lb-1457592956.us-east-2.elb.amazonaws.com" # <put your load_balancer address for section 1>
# Section 2
